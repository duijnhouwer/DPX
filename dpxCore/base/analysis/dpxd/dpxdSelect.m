...
p.addParamValue('subindex',[],@(x)dpxIsWholeNumber(x) && numel(x)==1);
p.addParamValue('numel_ge',[],@dpxIsWholeNumber);
p.addParamValue('numel_gt',[],@dpxIsWholeNumber);
p.addParamValue('numel_lt',[],@dpxIsWholeNumber);
p.addParamValue('numel_le',[],@dpxIsWholeNumber);
